...
export function CapabilitiesSection() {
  ...
  // The snippet is the first thing a developer copies, so it points at THIS gateway.
  // `server_address` is what the operator configured; without one, the address the
  // visitor is already on is the honest answer.
